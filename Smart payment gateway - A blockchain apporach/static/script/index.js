...
const initialize = () => {
    ...
    const onboardMetaMaskClient = async () => {
        if (!isMetamaskInstalled()) {
            ...
            document.getElementById('connectWalletBtn').innerHTML = "Click here to install metamask";
    ...
    const installMetaMask = () => {
        ...
        document.getElementById('connectWalletBtn').innerHTML = "Installation in progress";
        connectButton.disabled = true;
